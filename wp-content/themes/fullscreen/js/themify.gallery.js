...
;(function($){
	...
	var toggleContent = function(event){
		...
		if( 'keyup' == event.type && (27 != event.which || !$body.hasClass('fullscreen-active')) ){
                    return;
		}
	...
	$(document).ready(function() {
		...
		// Go fullscreen
		/////////////////////////////////////////////
		$('#fullscreen-button').on(themifyScript.isTouch? 'touchend' : 'click', toggleContent );
	...
	$(window).load(function(){
		...
		/////////////////////////////////////////////
                if ($footerSlider.length > 0) {
                    if(!$.fn.carouFredSel){
                        Themify.LoadAsync(themify_vars.url+'/js/carousel.js',ThemifyFooterSlider);
                    }
                    else{
                       ThemifyFooterSlider();
                    }  
                }
                function ThemifyFooterSlider(){
