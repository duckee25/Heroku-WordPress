...
/**
 * Adds body classname if Content Width option is set to Fullwidth in admin area
 *
 * @return string
 */
function themify_content_width_admin_body_class( $classes ) {
	global $hook_suffix, $post;
	if( 'post.php' == $hook_suffix ) {
		if( get_post_meta( $post->ID, 'content_width', true ) == 'full_width' ) {
			$classes .= ' themify-fullwidth-content';
		}
	}

	return $classes;
}
add_filter( 'admin_body_class', 'themify_content_width_admin_body_class' );