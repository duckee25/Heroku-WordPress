...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Following elements doesn't have a live preview and it's not styling.
		'clear' => array(
			'control' => array(
				'type'    => 'Themify_Clear_Control',
				'label'   => __( 'Reset All', 'themify' ),
			),
			'selector' => 'clear',
			'prop' => 'clear',
		),
		...
		'export' => array(
			'control' => array(
				'type'    => 'Themify_Export_Control',
				'label'   => __( 'Export', 'themify' ),
			),
			'selector' => 'export',
			'prop' => 'export',
		)
