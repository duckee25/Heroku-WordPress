<?php
/**
 * Bulk Actions creator module.
 *
 * Classes to add bulk actions to admin tables
 * this is a modification of: https://github.com/Seravo/wp-custom-bulk-actions
 *
 */
