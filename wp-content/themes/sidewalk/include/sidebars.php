...
if ( !function_exists( 'sdw_register_sidebars' ) ) :
	function sdw_register_sidebars() {
		
		/* Default Sidebar */
		register_sidebar(
			array(
				'id' => 'sdw_default_sidebar',
