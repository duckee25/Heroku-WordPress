...
?>
				<?php if ( pix_is_woocommerce() ) { ?></div><?php } ?>
...
<?php } ?>
			<article class="pix_grid_very_fluid">

				<?php if ( pix_is_woocommerce() ) { ?><div class="products"><?php } ?>
			...
			<div class="wrap_filter">
				<div class="pix_column pix_column_990">
                	...
                	<?php if ( $pix_sort == 'true' ) { ?>
                        <div class="pix_column pix_column_990 filters_wrap pix_loop_second">
                        ...
                        <?php if ( $layout == 'ninth' || $layout == 'tenth' ) { ?></div><?php } ?>
                    </div><!-- .pix_column_990 -->
	                <?php } ?>
...
<?php //} ?>
                ...
                <section class="pix_wall pix_load_content">
							...
							?>
								...
								<div class="entry post-id-<?php echo get_the_id(); ?>" data-sort="<?php echo $dataSort; ?>">
									...
									<?php										
										...
										if ( ($pix_titles!='0' && $pix_titles!='false') || (function_exists('printGetLikes') && $pix_like=='true') || $pix_more=='true' || ($pix_comments == 'true' && comments_open()) ) {
											$entry_content = '<div class="entry-sliding-content">';
									...
									if ( ( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) ) || 
										...
										echo '<div class="gallery-post-format pix_column pix_column_thumb '.$column_size.' alignleft">'.$entry_content;
										...
										if ( ($video_pos < $iframe_pos || $iframe_pos=='') && $video_pos!='' ) {
											...
											echo '<div class="video-post-format pix_column pix_column_thumb '.$column_size.' alignleft">'.$entry_content.'<table><tr><td>
												'.$match.'
											</td></tr></table></div>';
										} else {
										...
										if ( ($pix_titles!='0' && $pix_titles!='false') || (function_exists('printGetLikes') && $pix_like=='true') || $pix_more=='true' || ($pix_comments == 'true' && comments_open()) ) {
											...
											echo '<div class="entry-sliding-content">';
...
<?php if ( $inner_shortcode_found ) { ?>
	...
	<?php 
		$page_template_shortcode = get_post_meta( $post->ID, '_wp_page_template', true );
		$reopen_class =  (!isset($page_template_shortcode) || $page_template_shortcode == 'default' ) ? '730' : '990';
	?>

					</article><div><div><div class="pix_column pix_column_<?php echo $reopen_class; ?>"></div>
<?php } ?>
