<?php
function pix_google_arrays($families) {
$json = '{
   ...
   "files": {
	...
	foreach ( $decoded->items as $item ) {
		if (is_array($families) && in_array($item->family,$families)) {
			array_push($font_families, $item->family);
			array_push($font_variants, $item->variants);
			array_push($font_subsets, $item->subsets);
		}
	}
	pix_update_option('pix_font_families',$font_families);
	pix_update_option('pix_font_variants',$font_variants);
	pix_update_option('pix_font_subsets',$font_subsets);
}
?>