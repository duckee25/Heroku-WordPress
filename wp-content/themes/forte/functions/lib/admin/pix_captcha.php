...
function blog_captcha(){
	global $options;
	if ($_GET['page']=='blog_captcha') { 
?>
...
<div id="forte_dynamic_tab">
            ...
            <?php } ?>            
                ...
                <label for="pix_blog_captcha">Use captcha for the blog comments:</label>
                <input type="hidden" name="pix_blog_captcha" value="0">
                <input type="checkbox" name="pix_blog_captcha" value="true" <?php if(pix_esc_option('pix_blog_captcha')=='true') { echo 'checked="checked"'; } ?>>
