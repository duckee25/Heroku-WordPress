...
$cryptheight = 34;   // Hauteur du cryptogramme (en pixels)

$bgOpts = hex2RGB(pix_get_option('pix_captcha_bg'));
$bgR  = $bgOpts['red'];         // Couleur du fond au format RGB: Red (0->255)
$bgG  = $bgOpts['green'];         // Couleur du fond au format RGB: Green (0->255)
$bgB  = $bgOpts['blue'];         // Couleur du fond au format RGB: Blue (0->255)
...
$charOpts = hex2RGB(pix_get_option('pix_captcha_color'));
$charR = $charOpts['red'];     // Couleur des caractères au format RGB: Red (0->255)
$charG = $charOpts['green'];     // Couleur des caractères au format RGB: Green (0->255)
$charB = $charOpts['blue'];     // Couleur des caractères au format RGB: Blue (0->255)
...
$noiselinemin = 10;     // Bruit: Nb minimum de lignes aléatoires
$noiselinemax = 10;     // Bruit: Nb maximum de lignes aléatoires

$nbcirclemin = 10;      // Bruit: Nb minimum de cercles aléatoires 
$nbcirclemax = 10;      // Bruit: Nb maximim de cercles aléatoires
