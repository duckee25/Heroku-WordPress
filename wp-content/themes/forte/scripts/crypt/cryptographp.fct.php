...
// -----------------------------------------------
 ...
 function dsp_crypt() {
 return "<img id='cryptogram' class='alignleft pixImageLoaded' src='".$_SESSION['cryptdir']."/cryptographp.php?cfg=".$cfg."&".SID."' width='100' height='34'><a class='recaptcha letmebe' title='".($reload==1?'':$reload)."' style=\"cursor:pointer;\" onclick=\"javascript:document.images.cryptogram.src='".$_SESSION['cryptdir']."/cryptographp.php?cfg=".$cfg."&".SID."&'+Math.round(Math.random(0)*1000)+1\"><i class=\"icon-refresh\"></i></a>";
 }
