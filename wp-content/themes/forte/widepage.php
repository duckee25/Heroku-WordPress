            ...
            <article>
				...
				<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
                    ...
                    <?php
                        ...
                        if ( ($multipage && $page != 1) || $page_builder=='on' || post_password_required() ) {
                            echo '<section>
                                <div class="pix_column pix_column_990">
                ...
                <section>
                    <div class="pix_column pix_column_990">
                        ...
                        <?php if ( ( pix_get_option('pix_share_pages') == 'true' && get_post_meta( $post->ID, 'pix_pag_opts_share', true ) == '' ) || get_post_meta( $post->ID, 'pix_pag_opts_share', true ) == 'display' ) { ?>
